...
router
  .route('/')
  .post(/*auth('manageOrders'), */ upload.single('file_url'), validate(orderValidation.createOrder), orderController.createOrder)
...
router
  ...
  .patch(/*auth('manageOrders'),*/ upload.single('file_url'), validate(orderValidation.updateOrder), orderController.updateOrder)
